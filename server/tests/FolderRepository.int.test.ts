...
import { FolderRepository } from 'oldsrc/modules/folder/repositories/FolderRepository.ts'
...
describe('FolderRepository tests', () => {
    ...
    it('should find all unique subfolder ids for given root ids', async () => {
        ...
        await services.prisma.client.folder.createMany({
            data: [
    ...
    it('should return empty array if there are no subfolders', async () => {
        ...
        await services.prisma.client.folder.create({
            data: {
                id: lonelyRoot,
                name: 'Lonely Root',
                workspaceId: WORKSPACE_ID,
