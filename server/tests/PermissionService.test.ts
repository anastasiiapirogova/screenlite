...
import { WorkspaceRole } from 'oldsrc/modules/member/types.ts'
import { WORKSPACE_PERMISSIONS } from 'oldsrc/modules/workspace/accessControl/permissions.ts'
import { PermissionService } from 'oldsrc/modules/workspace/accessControl/services/PermissionService.ts'
