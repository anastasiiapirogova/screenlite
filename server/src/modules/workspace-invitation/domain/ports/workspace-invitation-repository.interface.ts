...
import { WorkspaceInvitationsQueryOptionsDTO } from '../dto/workspace-invitations-query-options.dto.ts'
...
export interface IWorkspaceInvitationRepository {
    ...
    findAll(queryOptions: WorkspaceInvitationsQueryOptionsDTO): Promise<PaginationResponse<WorkspaceInvitation>>
