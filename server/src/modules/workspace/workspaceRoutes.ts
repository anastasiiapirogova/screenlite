...
import FileController from '@/modules/workspace/modules/file/controllers/index.ts'
import MemberController from '@/modules/workspace/modules/member/controllers/index.ts'
import PlaylistController from '@/modules/workspace/modules/playlist/controllers/index.ts'
import PlaylistLayoutController from '@/modules/workspace/modules/playlistLayout/controllers/index.ts'
import PlaylistScheduleController from '@/modules/workspace/modules/playlistSchedule/controllers/index.ts'
import ScreenController from '@/modules/workspace/modules/screen/controllers/index.ts'
...
import FileUploadController from '@/modules/workspace/modules/fileUpload/controllers/index.ts'
