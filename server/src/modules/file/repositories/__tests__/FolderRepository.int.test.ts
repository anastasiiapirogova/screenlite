...
describe('FolderRepository tests', () => {
    beforeAll(async () => {
        await prisma.workspace.upsert({
            ...
            update: {},
            create: { id: WORKSPACE_ID, name: 'Test Workspace', slug: 'test-workspace', status: 'ACTIVE' },
        })
    })
    ...
    it('should create a folder and retrieve it by workspace and id', async () => {
        ...
        const found = await FolderRepository.findFolderInWorkspace(folderData.workspaceId, folderData.id)
