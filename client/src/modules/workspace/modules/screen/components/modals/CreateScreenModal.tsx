...
import { CreateScreenRequestData } from '@modules/workspace/modules/screen/types'
import { createScreenRequest } from '@modules/workspace/modules/screen/api/requests/createScreenRequest'
import { screenQuery } from '@modules/workspace/modules/screen/api/queries/screenQuery'
import { InputLabelGroup } from '@shared/ui/input/InputLabelGroup'
import { InputError } from '@shared/ui/input/InputError'
import { screenTypes } from '@modules/workspace/modules/screen/helper/screenTypes'
